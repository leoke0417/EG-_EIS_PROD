...
class file_operate(object):
    ...
    def list_dict1_get(self, dic_value):
        ## Example:
        ##
        ##    [
        ##        {
        ...
        try:
            ...
            dic_target_onedot = json_file[0]
            print(dic_target_onedot)
            return dic_target_onedot
        except:
            raise error.notfind()
        

    def dict_list_dict_dict_list_dict_value_pdb_get(self, dic_value):
        ## Example:
        ##
        ##    {
        ##        "xxx": "yyy",
        ...
        try:
            ...
            for i in range(len(json_file[dic_value["first_key"]])):
                for j in range(len(json_file[dic_value["first_key"]][i][dic_value["second_key"]][dic_value["third_key"]])):
                    if "PWDBoard" == json_file[dic_value["first_key"]][i][dic_value["second_key"]][dic_value["third_key"]][j]["model"]:
                        for k in range(len(json_file[dic_value["first_key"]][i][dic_value["second_key"]][dic_value["third_key"]][j][dic_value["fourth_key"]])):
                            list_values.append(json_file[dic_value["first_key"]][i][dic_value["second_key"]][dic_value["third_key"]][j][dic_value["fourth_key"]][k][dic_value["fifth_key"]])
            print("\n {} \n".format(list_values))
            return list_values
    ...
    def list_get(self, dic_value):
        ...
        if 'response_body' in dic_value.keys():
            ...
            raise error.nonamevalue() 
        try:
            ye = eval(dic_value['response_body'])
            te =ye[0]
            print(te)
            return te
        except:
